...
public class MyItemCustomAdapter extends ArrayAdapter<Item> {
    ...
    MyItemCustomAdapter(Context context, int resource,@NonNull ArrayList<Item> object) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try{
            ...
            if(convertView == null){
                ...
                holder.quantityTextView.setText(String.valueOf(itemCount+1));
                ...
                holder.plusTextView.setVisibility(View.INVISIBLE);
                holder.minusTextView.setVisibility(View.INVISIBLE);
